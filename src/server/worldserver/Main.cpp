...
#ifndef _LAS_CORE_CONFIG
# define _LAS_CORE_CONFIG  "worldserver.conf"
#endif //_LAS_CORE_CONFIG

#ifdef _WIN32
#include "ServiceWin32.h"
char serviceName[] = "worldserver";
char serviceLongName[] = "LasCore world service";
char serviceDescription[] = "LasCore World of Warcraft emulator world service";
/*
...
extern int main(int argc, char **argv)
{
    ...
    // 0 - normal shutdown
    // 1 - shutdown at error
    // 2 - restart command used, this code can be used by restarter for restart Lasd
