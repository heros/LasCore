...
public:
    ...
    ChatCommand* GetCommands() const
    {
        ...
        static ChatCommand reloadCommandTable[] =
        {
            ...
            { "las_string",                   SEC_ADMINISTRATOR, true,  &HandleReloadTrinityStringCommand,              "", NULL },
    ...
    {
        sLog->outInfo(LOG_FILTER_GENERAL, "Re-Loading las_string Table!");
        sObjectMgr->LoadTrinityStrings();
        handler->SendGlobalGMSysMessage("DB table `las_string` reloaded.");
        return true;
    }
