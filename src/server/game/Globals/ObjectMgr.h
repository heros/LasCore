...
#define MIN_las_string_ID           1                    // 'las_string'
#define MAX_las_string_ID           2000000000
#define MIN_DB_SCRIPT_STRING_ID        MAX_las_string_ID // 'db_script_string'
...
class ObjectMgr
{
    ...
    public:
        ...
        bool LoadTrinityStrings() { return LoadTrinityStrings("las_string", MIN_las_string_ID, MAX_las_string_ID); }
